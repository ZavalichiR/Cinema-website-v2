<%@ page contentType="text/html; charset=UTF-8" %>
	...
	<div id="slogan">
		...
		<div class="inside">
			...
			<p>Vizualizează-te ca pe ecranul de cinema. Privește-te reușind deja să faci și să obții ce dorești..</p>
		</div>
    </div>
    <div class="box">
        <div class="inner">
    ...
    <div class="box2"> 
		...
		<ul class="movies">
		    <li>
				<h4>Star Wars</h4>
				<a class="selectImg" href='film.jsp?idFilm=2'><img src="images/Filme/StarWars.jpg"  alt="Star Wars" /></a>
			...
			<li>
				...
				<a class="selectImg" href='film.jsp?idFilm=3' ><img src="images/Filme/JocuriSecrete.jpg" alt="Jocuri Secrete" /></a>
			...
			<li class="last">
				<h4>Jumanji</h4>
				<a class="selectImg" href='film.jsp?idFilm=4' ><img src="images/Filme/Jumanji.jpg" alt="Jumanji" /></a>
